...
function mobile1SetUp () {
    ...
    /* when inside a post */
    if ((/\bmod=viewthread\b/.test(window.location.search) || /\bthread-\b/.test(window.location.href)) && !/\baction=\b/.test(window.location.search)) {
        postPageSetUp();
    }
